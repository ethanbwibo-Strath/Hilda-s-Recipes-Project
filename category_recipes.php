...
$stmt = $conn->prepare("SELECT * FROM tblrecipes WHERE Category = ?");
...
<html>
<head>
    <title><?php echo htmlspecialchars($category); ?> Recipes</title>
...
<div class="container">
    <h2 class="ViewRecipesTitle"><?php echo htmlspecialchars($category); ?> Recipes</h2>
